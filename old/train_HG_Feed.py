...
train_data = DataGenerator(imgdir=params["train_img_path"], txt="/media/bnrc2/_backup/dataset/aiclg/data.txt", batch_size=params['batch_size'], is_aug=False,
                           joints_name=
                           params["joints"],isTraing=False)  # , refine_num = 10000)
...
train_log_dir = "/media/bnrc2/_backup/log/test_gan_gpu/feed/train.log"
valid_log_dir = "/media/bnrc2/_backup/log/test_gan_gpu/feed/valid.log"
...
trainer = train_class(model, nstack=network_params['nstack'], batch_size=params['batch_size'],
                              ...
                              logdir_valid=valid_log_dir,name='gan',
                               train_record=train_data,
                              save_model_dir="/media/bnrc2/_backup/models/hg2/",valid_record=valid_data,
