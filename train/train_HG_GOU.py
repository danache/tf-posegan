...
from train.train_class_HG_Tensor_GOU import train_class
...
train_log_dir = "/media/bnrc2/_backup/log/test_gan_gpu/Tensor/train.log"
valid_log_dir = "/media/bnrc2/_backup/log/test_gan_gpu/Tensor/valid.log"
